...
1. A properties struct (`ModelProperties`) defines several model parameters:
  ...
  - `d̄` : constant for dividend process (default = `10.0`)
...
- runs the model 25 times over 250,000 steps under different random seeds and aggregates the results over the repetitions, 
