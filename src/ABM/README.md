...
1. A properties struct (`ModelProperties`) defines several model parameters:
  ...
  - `price_min` : minimum price for risky asset (default = `0.01`)
  - `price_max` : maximum price for risky asset (default = `200.0`)
  ...
  - `itermax` : maximum number of allowable iterations to obtain clearing price (default = `500`)
